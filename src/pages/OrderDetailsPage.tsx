                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl sm:rounded-2xl shadow-md border-2 border-gray-200 p-4 sm:p-6 lg:sticky lg:top-4">
                            ...
                            <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t-2 border-gray-300">
                                <button className="w-full flex items-center justify-center gap-2 bg-white border-2 border-gray-300 text-gray-700 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl text-sm sm:text-base font-bold hover:bg-gray-50 hover:border-gray-400 transition-all">
